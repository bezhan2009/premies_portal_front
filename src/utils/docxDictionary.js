...
export const docxDictionary = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "card.accountNumbers", description: "Номер счета карты — все счета (до 3)" },
      { key: "card.accountNumber1", description: "Номер счета карты 1" },
      { key: "card.accountNumber2", description: "Номер счета карты 2" },
      { key: "card.accountNumber3", description: "Номер счета карты 3" },
      ...
      { key: "card.openDate", description: "Дата открытия карты" },
      { key: "card.productName", description: "Название карточного продукта" },
