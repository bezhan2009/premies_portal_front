                ...
                {settings.length === 0 ? (
                  ...
                  settings.map((setting) => (
                    <tr key={`setting-${setting.id}`}>
                      ...
                      <td>{setting.lastBalance !== undefined ? setting.lastBalance.toLocaleString('ru-RU') + ' TJS' : '-'}</td>
                      <td>{setting.lastCheckedAt && setting.lastCheckedAt !== "0001-01-01T00:00:00Z" ? formatDate(setting.lastCheckedAt) : "еще не проверялась"}</td>
                      <td>
