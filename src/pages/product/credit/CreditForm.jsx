  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        <Collapse accordion defaultActiveKey={["main", "logic", "terms", "rates", "age", "documents"]}>
          <Collapse.Panel header="Основные данные" key="main">
            ...
            <Form.Item name="loanType" label="Тип кредита">
              <Select placeholder="Выберите тип кредита" style={{ width: "100%" }} allowClear>
          ...
          <Collapse.Panel header="Логические поля" key="logic">
            <Row gutter={[16, 16]}>
              ...
              <Col span={8}>
                <Form.Item name="collateralRequired" label="Требуется залог" valuePropName="checked">
                  <Switch />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item name="insuranceRequired" label="Требуется страховка" valuePropName="checked">
                  <Switch />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="minAmount" label="Мин. сумма">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите минимальную сумму" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="maxAmount" label="Макс. сумма">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите максимальную сумму" />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="minTermInMonths" label="Мин. срок (мес)">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите минимальный срок" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="maxTermInMonths" label="Макс. срок (мес)">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите максимальный срок" />
                </Form.Item>
              </Col>
            </Row>
            <Form.Item name="gracePeriodMonths" label="Льготный период (мес)">
              <InputNumber style={{ width: "100%" }} placeholder="Введите льготный период" />
            </Form.Item>
            <Form.Item name="earlyRepaymentFee" label="Комиссия за досрочное погашение">
              <InputNumber style={{ width: "100%" }} placeholder="Введите комиссию" />
            </Form.Item>
            <Form.Item name="applicationProcessingTime" label="Срок обработки заявки">
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="interestRateFrom" label="Процент от">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите процент от" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="interestRateTo" label="Процент до">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите процент до" />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="effectiveRateFrom" label="Эффективная ставка от">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите эффективную ставку от" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="effectiveRateTo" label="Эффективная ставка до">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите эффективную ставку до" />
                </Form.Item>
              </Col>
            </Row>
          </Collapse.Panel>
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="ageMin" label="Мин. возраст">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите минимальный возраст" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="ageMax" label="Макс. возраст">
                  <InputNumber style={{ width: "100%" }} placeholder="Введите максимальный возраст" />
                </Form.Item>
              </Col>
            </Row>
            <Form.Item name="incomeRequirement" label="Требуемый доход">
              <InputNumber style={{ width: "100%" }} placeholder="Введите требуемый доход" />
            </Form.Item>
          </Collapse.Panel>
          ...
          <Collapse.Panel header="Документы" key="documents">
            ...
            >
              <Input.TextArea rows={4} placeholder="Каждый документ с новой строки" />
            </Form.Item>
          </Collapse.Panel>
        </Collapse>
      </Form>
