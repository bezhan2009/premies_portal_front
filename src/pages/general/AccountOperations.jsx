                                ...
                                <div className="search-card">
                                    <div className="search-card__content">
                                        ...
                                        <div className="search-card__input-group">
                                            <label htmlFor="accountNumber" className="search-card__label">
                                                Номер счета
                                            </label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="limits-table__container">
                                        <div className="limits-table__wrapper">
                                            <table className="limits-table__content">
                                                ...
                                                <tr>
                                                    <th className="limits-table__th">Дата операции (DOPER)</th>
                                                    <th className="limits-table__th">Дата документа (DOCDOPER)</th>
                                                    <th className="limits-table__th">Время (EXECDT)</th>
                                                    <th className="limits-table__th">Описание (TXTDSCR)</th>
                                                    <th className="limits-table__th">Дебет (MOVD)</th>
                                                    <th className="limits-table__th">Кредит (MOVC)</th>
                                                    <th className="limits-table__th">Баланс на конец (SumBalOut)</th>
                                                    <th className="limits-table__th">Валютная дата (DVAL)</th>
                                                    <th className="limits-table__th">Референс (REFER)</th>
                                                    <th className="limits-table__th">Номер документа (NUMDOC)</th>
                                                    <th className="limits-table__th">Клиент корреспондент (CLIENTCOR)</th>
                                                    <th className="limits-table__th">Счет корреспондент (ACCCOR)</th>
                                                    <th className="limits-table__th">Банк корреспондент (NAMEBCR)</th>
                                                ...
                                                {transactions.map((transaction, index) => (
                                                    <tr key={`${transaction.PID}-${index}`} className="limits-table__row transaction-row">
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.doper || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.DOCDOPER || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.EXECDT || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.TXTDSCR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="amount-value">{formatAmount(transaction.MOVD)}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="amount-value">{formatAmount(transaction.MOVC)}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="amount-value">{formatAmount(transaction.sumBalOut)}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.DVAL || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.REFER || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.NUMDOC || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.CLIENTCOR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.ACCCOR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.NAMEBCR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.kurs || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.PDepID || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.PID || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.KSOCODE || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.BNKKOR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.JCODEBE || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.JRNNCR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="amount-value">{formatAmount(transaction.MOVDN)}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="amount-value">{formatAmount(transaction.MOVCN)}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.CODEBCR || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.KNP || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.CODEBC || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.TXT_HEAD || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.TXT_BUCH || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.CMSFL || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.PARENT_REFER || 'N/A'}</span>
                                                        </td>
                                                        <td className="limits-table__td limits-table__td--value">
                                                            <span className="default-value">{transaction.KURS_ISP || 'N/A'}</span>
                                                        </td>
                                                    </tr>
                                                ))}
                                                </tbody>
