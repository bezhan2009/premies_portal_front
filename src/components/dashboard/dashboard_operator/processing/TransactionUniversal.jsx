              ...
              <div className="txn-filter__body">
                  ...
                  <div className="txn-filter__fields">
                    ...
                    <div className="txn-filter__field">
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.35rem' }}>
                        <label htmlFor="atmId" className="txn-filter__label" style={{ margin: 0 }}>
                          ATM ID
                        </label>
                        <button
                          type="button"
                ...
                <div className="txn-filter__section">
                  ...
                  <div className="txn-filter__fields">
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.35rem' }}>
                        <label className="txn-filter__label" style={{ margin: 0 }}>
                          Типы транзакций
                        </label>
                        <button
                          type="button"
                    ...
                    <div className="txn-filter__field">
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.35rem' }}>
                        <label htmlFor="mcc" className="txn-filter__label" style={{ margin: 0 }}>
                          MCC
                        </label>
                        <button
                          type="button"
                    ...
                    <div className="txn-filter__field">
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.35rem' }}>
                        <label htmlFor="responseCode" className="txn-filter__label" style={{ margin: 0 }}>
                          Response code
                        </label>
                        <button
                          type="button"
