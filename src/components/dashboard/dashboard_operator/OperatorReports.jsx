      ...
      case 'mb':
        return (
          <motion.div key="mb" {...commonProps}>
            <Filters initialDate="2025-06-21" modificationDesc="Отчет по МБ" />
            <TableReportsMb />
          </motion.div>
        );
      ...
      case 'kc':
        return (
          <motion.div key="kc" {...commonProps}>
            <Filters initialDate="2025-06-21" modificationDesc="Отчет КЦ" />
            <TableReportsKc />
          </motion.div>
        );
      ...
      case 'test':
        return (
          <motion.div key="test" {...commonProps}>
            <Filters initialDate="2025-06-21" modificationDesc="Отчет Тест" />
            <TableReportsTest />
          </motion.div>
        );
      ...
      default:
        return (
          <motion.div key="cards" {...commonProps}>
            <Filters initialDate="2025-06-21" modificationDesc="Отчет по картам" />
            <TableReportsCards />
          </motion.div>
        );
    }
