        ...
        <div className="custom-tooltip">
            ...
            <div className="tooltip-content">
                <div className="tooltip-row">
                    <span className="tooltip-label">Сумма:</span>
                    <span className="tooltip-value">{formatIntWithDots(p.amount)}</span>
                </div>

                {p.terminalId && (
                    <div className="tooltip-row">
                        <span className="tooltip-label">Банкомат:</span>
                        <span className="tooltip-value">{p.terminalId}</span>
                    </div>
                )}

                {p.rrn && (
                    <div className="tooltip-row">
                        <span className="tooltip-label">RRN:</span>
                        <span className="tooltip-value">{p.rrn}</span>
                    </div>
                )}

                {p.stan && (
                    <div className="tooltip-row">
                        <span className="tooltip-label">STAN:</span>
                        <span className="tooltip-value">{p.stan}</span>
                    </div>
                )}
            </div>
        </div>
