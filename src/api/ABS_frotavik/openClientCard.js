...
import { cardAccountChoicePayload } from './cardAccountChoice';
...
export const selectCardAccount = async (code, id, number) => (await api.post(`${path(code)}/${encodeURIComponent(id)}/account`, cardAccountChoicePayload(number), options)).data;
