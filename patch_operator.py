...
def patch_operator_file(filepath):
...
"""
    ...
    # 3. Add onContextMenu to group item
    ...
    # 4. Fix group onClick for selection mode
...
patch_operator_file(r'd:\Work\Activ bank\activ daily\premies_portal_front\src\pages\dashboard\dashboard_operator\OperatorFeedbackPage.jsx')
